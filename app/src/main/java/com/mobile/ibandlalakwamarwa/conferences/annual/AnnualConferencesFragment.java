...
public class AnnualConferencesFragment extends Fragment {
    private static String TAG = AnnualConferencesFragment.class.getSimpleName();
    private final static String SHARE_PREFERENCES_FILE = "annualConference";
    private final static String SHARED_PREFERENCES_KEY = "annualConference_key";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_annual_conferences, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.annual_conf_recycler_view);
    ...
    private void showScreen() {
        AddAnnualConferenceFragment addConferencce = new AddAnnualConferenceFragment();
    ...
    public void onResume() {
        ...
        requireActivity().setTitle("Izinkonzo Zonyaka");
    }
